...
namespace PuzzleLab.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250418112558_MigrateSchedules")]
    partial class MigrateSchedules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PuzzleLab.Domain.Entities.Schedule", b =>
                {
                    ...
                    b.HasIndex("QuestionPackageId")
                        .HasDatabaseName("ix_schedules_question_package_id");
            ...
            modelBuilder.Entity("PuzzleLab.Domain.Entities.Schedule", b =>
                {
                    b.HasOne("PuzzleLab.Domain.Entities.QuestionPackage", null)
                        .WithMany("Schedules")
                        .HasForeignKey("QuestionPackageId")
                        .HasConstraintName("fk_schedules_question_packages_question_package_id");
                });
