...
namespace PuzzleLab.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250421191115_MigrateQuizSessionQuestions")]
    partial class MigrateQuizSessionQuestions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PuzzleLab.Domain.Entities.QuizSessionQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_quiz_session_questions");

                    b.HasIndex("QuestionId")
                        .HasDatabaseName("ix_quiz_session_questions_question_id");

                    b.HasIndex("QuizSessionId")
                        .HasDatabaseName("ix_quiz_session_questions_quiz_session_id");
            ...
            modelBuilder.Entity("PuzzleLab.Domain.Entities.QuizSessionQuestion", b =>
                {
                    b.HasOne("PuzzleLab.Domain.Entities.Question", "Question")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_quiz_session_questions_questions_question_id");
                    ...
                    b.HasOne("PuzzleLab.Domain.Entities.QuizSession", "QuizSession")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_quiz_session_questions_quiz_sessions_quiz_session_id");
